...
在同一时间内，系统只能处理一个请求
在一分钟内，你最多可以发送3个请求
在一分钟内，你最多可以处理32000个 Tokens
在一天内，你最多可以处理1500000个 Tokens
"""


class ChatbotGUI:
    def __init__(self, root, key='sk-key-https://platform.moonshot.cn/console/api-keys', model='moonshot-v1-8k'):
        ...
        self.model_name = model  # Using Kimi model
